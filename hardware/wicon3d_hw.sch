...
<pin name="S" x="-12.7" y="-10.16" length="middle" direction="in"/>
<pin name="I0A" x="-12.7" y="12.7" length="middle" direction="in"/>
<pin name="I1A" x="-12.7" y="10.16" length="middle" direction="in"/>
<pin name="ZA" x="12.7" y="12.7" length="middle" direction="out" rot="R180"/>
<pin name="I0B" x="-12.7" y="7.62" length="middle" direction="in"/>
<pin name="I1B" x="-12.7" y="5.08" length="middle" direction="in"/>
<pin name="ZB" x="12.7" y="7.62" length="middle" direction="out" rot="R180"/>
<pin name="ZC" x="12.7" y="2.54" length="middle" direction="out" rot="R180"/>
<pin name="I1C" x="-12.7" y="0" length="middle" direction="in"/>
<pin name="I0C" x="-12.7" y="2.54" length="middle" direction="in"/>
<pin name="ZD" x="12.7" y="-2.54" length="middle" direction="out" rot="R180"/>
<pin name="I1D" x="-12.7" y="-5.08" length="middle" direction="in"/>
<pin name="I0D" x="-12.7" y="-2.54" length="middle" direction="in"/>
<pin name="!E" x="-12.7" y="-12.7" length="middle" direction="in" function="dot"/>
</symbol>
<symbol name="PWRN">
...
<devicesets>
<deviceset name="74LVX157" prefix="IC">
<description>Low Voltage Quad 2-Input Multiplexer</description>
<gates>
...
<connect gate="A" pin="I0A" pad="2"/>
<connect gate="A" pin="I0B" pad="5"/>
<connect gate="A" pin="I0C" pad="14"/>
<connect gate="A" pin="I0D" pad="11"/>
<connect gate="A" pin="I1A" pad="3"/>
<connect gate="A" pin="I1B" pad="6"/>
<connect gate="A" pin="I1C" pad="13"/>
<connect gate="A" pin="I1D" pad="10"/>
<connect gate="A" pin="S" pad="1"/>
<connect gate="A" pin="ZA" pad="4"/>
<connect gate="A" pin="ZB" pad="7"/>
<connect gate="A" pin="ZC" pad="12"/>
<connect gate="A" pin="ZD" pad="9"/>
...
<part name="SW-RST" library="switch-tact" deviceset="DTSM-6" device=""/>
<part name="SW-FLASH" library="switch-tact" deviceset="DTSM-6" device=""/>
...
<part name="RAMPS_SER" library="con-lstb" deviceset="MA04-1" device=""/>
<part name="12V_INPUT" library="con-molex" deviceset="22-23-2021" device="" value="power in"/>
<part name="IC2" library="fairchild-semic" deviceset="74LVX157" device=""/>
<part name="U1" library="SparkFun-Connectors" deviceset="SD_CARD_SOCKET" device=""/>
...
<instances>
<instance part="MDL1" gate="G$1" x="137.16" y="60.96"/>
<instance part="IC1" gate="G$1" x="167.64" y="33.02"/>
<instance part="C1" gate="G$1" x="180.34" y="27.94"/>
<instance part="SW-RST" gate="G$1" x="106.68" y="81.28" rot="R270"/>
<instance part="SW-FLASH" gate="G$1" x="172.72" y="60.96" rot="R270"/>
<instance part="Q1" gate="G$1" x="127" y="106.68" rot="R270"/>
<instance part="Q2" gate="G$1" x="160.02" y="106.68" rot="R270"/>
...
<instance part="R4" gate="G$1" x="167.64" y="114.3" rot="R90"/>
<instance part="RAMPS_SER" gate="1" x="195.58" y="114.3" rot="MR0"/>
<instance part="12V_INPUT" gate="-1" x="144.78" y="22.86" rot="MR0"/>
<instance part="12V_INPUT" gate="-2" x="144.78" y="20.32" rot="MR0"/>
<instance part="IC2" gate="A" x="0" y="66.04"/>
<instance part="U1" gate="G$1" x="45.72" y="63.5"/>
<instance part="SV1" gate="G$1" x="-12.7" y="104.14" rot="R180"/>
<instance part="P+2" gate="1" x="144.78" y="30.48"/>
<instance part="GND1" gate="1" x="162.56" y="20.32"/>
<instance part="+3V2" gate="G$1" x="88.9" y="124.46"/>
<instance part="+3V3" gate="G$1" x="193.04" y="40.64"/>
<instance part="GND2" gate="1" x="185.42" y="93.98"/>
<instance part="+3V4" gate="G$1" x="99.06" y="45.72" rot="R90"/>
...
<instance part="GND7" gate="1" x="27.94" y="40.64"/>
<instance part="+3V5" gate="G$1" x="30.48" y="91.44"/>
<instance part="GND6" gate="1" x="-17.78" y="40.64"/>
<instance part="GND8" gate="1" x="-38.1" y="93.98"/>
<instance part="IC2" gate="P" x="-2.54" y="33.02" rot="R270"/>
<instance part="+3V6" gate="G$1" x="12.7" y="35.56"/>
...
<pinref part="12V_INPUT" gate="-2" pin="S"/>
...
<pinref part="RAMPS_SER" gate="1" pin="3"/>
<wire x1="185.42" y1="114.3" x2="187.96" y2="114.3" width="0.1524" layer="91"/>
</segment>
<segment>
<pinref part="SW-FLASH" gate="G$1" pin="3"/>
<pinref part="SW-FLASH" gate="G$1" pin="4"/>
...
<segment>
<pinref part="SW-RST" gate="G$1" pin="3"/>
...
<pinref part="SW-RST" gate="G$1" pin="4"/>
...
<segment>
<pinref part="SW-FLASH" gate="G$1" pin="2"/>
<pinref part="SW-FLASH" gate="G$1" pin="1"/>
...
<net name="SD_HOST_SELECT" class="0">
<segment>
...
<pinref part="RAMPS_SER" gate="1" pin="2"/>
...
<pinref part="RAMPS_SER" gate="1" pin="4"/>
...
<pinref part="RAMPS_SER" gate="1" pin="1"/>
...
<segment>
<pinref part="IC2" gate="A" pin="I0B"/>
...
<segment>
<pinref part="IC2" gate="A" pin="I0A"/>
...
<segment>
<pinref part="IC2" gate="A" pin="I0C"/>
...
<pinref part="12V_INPUT" gate="-1" pin="S"/>
...
<net name="5V_CS" class="0">
<segment>
<pinref part="IC2" gate="A" pin="I1A"/>
...
<segment>
<pinref part="IC2" gate="A" pin="I1B"/>
...
<net name="5V_CLK" class="0">
<segment>
<pinref part="IC2" gate="A" pin="I1C"/>
